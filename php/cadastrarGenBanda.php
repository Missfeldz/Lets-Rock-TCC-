...
<head>
    ...
    <title>Gênero Banda</title>
</head>
<body>
    <main class="container">
        <h2><i class="fas fa-drum"></i> Cadastro Gênero  Let's Rock</h2>
        <form action="verificaInsGenBanda.php" method="POST">
            <input type="hidden" id="idbanda" name="idbanda" value="<?php echo $_GET["idbanda"];?>">
